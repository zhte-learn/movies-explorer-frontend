        ...
        <div className="container container_two-column">
          <div className="student__info">
            ...
            <ul className="student__social">
              <li><a className="student__social-link" href="https://facebook.com" target="_blank" rel="noreferrer">Facebook</a></li>
              <li><a className="student__social-link" href="https://github.com" target="_blank" rel="noreferrer">Github</a></li>
            </ul>
          </div> 
